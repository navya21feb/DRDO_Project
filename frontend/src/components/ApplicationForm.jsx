...
const drdoLabs = [
  ...
  const handleSubmit = () => {
    if (
      ...
      !applicationData.researchArea ||
      !applicationData.coverLetter ||
      !applicationData.expectedStartDate ||
  ...
  const removeFile = (index) => {
    const newFiles = applicationData.documents.filter((_, i) => i !== index);
    setApplicationData({ ...applicationData, documents: newFiles });
  };
              ...
              <div className="space-y-3 pointer-events-none">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Resume, Academic Transcripts, ID Proof, NOC (if required)
                  </p>
            ...
            {applicationData.documents.length > 0 && (
              <div className="space-y-2">
                <h4 className="text-sm font-medium text-gray-700 flex items-center gap-2">
                  ...
                  Uploaded Documents ({applicationData.documents.length})
                </h4>
                <div className="space-y-2">
